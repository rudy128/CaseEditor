            ...
            <div className='w-[70%] flex flex-col gap-y-6 justify-center items-center p-12 bg-white rounded-2xl border border-grey shadow-xl'>
                ...
                <form action="" className='w-full'>
                    <div className='flex flex-col gap-y-3 my-4 w-full'>
                        ...
                        <input type="text" placeholder='Your Name' required className='rounded-xl border border-grey p-4' />
                    </div>
                    <div className='flex flex-col gap-y-3 my-4 w-full'>
                    ...
                    <button className='w-full my-4 py-4 text-white bg-green-600 hover:bg-green-500 flex justify-center items-center rounded-2xl'>Signup<ArrowRight className='ml-1.5 h-5 w-5' /></button>
                </form>
            </div>
        </div>
    )
